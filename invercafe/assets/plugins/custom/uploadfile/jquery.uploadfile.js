...
(function ($) {
    ...
    $.fn.uploadFile = function (options, fileNameDest, extension) {
        ...
        var s = $.extend({
            ...
            acceptFiles: "*",
            fileName: "file",
            formData: {"fileNameDest": fileNameDest},
            ...
            errorClass: "mt-3 text-danger",
            uploadButtonClass: "ajax-file-upload",
            dragDropStr: "<span class='text-dark font-weight-bold'>Puede arrastrar y soltar archivos en este espacio</span>",
            
            uploadStr:"Cargar",
            abortStr: "Abortar",
            cancelStr: "Cancelar",
            deletelStr: "No cargar este archivo...",
            doneStr: "Listo",
            multiDragErrorStr: "<span class='text-danger'>Arrastrar y soltar m&uacute;ltiples archivos no est&aacute; permitido.</span>",
            extErrorStr: "<span class='text-danger'>No es una extensi&oacute;n permitida. Extensiones permitidas: </span>",
            sizeErrorStr: "<span class='text-danger'>No est&aacute; permitido. Tama&ntilde;o m&aacute;ximo permitido: </span>",
            uploadErrorStr: "<span class='text-danger'>Carga no permitida</span>",
            duplicateErrorStr: "<span class='text-danger'>No est&aacute; permitido. El archivo ya existe.</span>",
            maxFileCountErrorStr: " <span class='text-danger'>No est&aacute; permitido. Máximos archivos permitidos: </span>",
                    ...
                    if(s.showStatusAfterSuccess) {
                        if(s.showDone) {
                            ...
                            pd.done.click(function () {
                                ...
                                pd.statusbar.remove();
                                if(s.doneCallback) s.doneCallback.call(this, data,pd);
                            });
                        } else {
                            pd.done.hide();
                        }
