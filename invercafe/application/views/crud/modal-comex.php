...
<div class="modal-content">
	<div class="modal-header">
		<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Globe.svg-->
		...
		<h5 class="modal-title" id="exampleModalLabel">Módulo Comex</h5>
							...
							<div class="table-responsive detalle-venta">
								<table id="table-fijacion-lotes" class="table table-head-custom table-head-bg table-borderless table-vertical-center">
									...
									<?php if(isset($contrato->TCONId)) {
										...
										<tr>
											<td class="text-success font-weight-bolder <?php echo ($item->DETNroLote == "" ? "" : "table-success") ?>"><?php echo ($item->DETKilos != "" ? sprintf("%06d", $item->DETNroLote) : "Bolsa") ?></td>
											...
											<td><?php echo $item->DETTipoPrecio ?></td>
											<td class="text-dark font-weight-bolder"><?php echo $item->DETUsdLbs ?></td>
											<td><?php echo ($item->Certificacion != $item->LOTCostoCertificado ? : "") ?></td>
											<td class="text-success"><?php echo ($item->DETUsdLbs - $item->LOTCostoCertificado - ($contrato->CONTComisionBroker == "" ? "0" : $contrato->CONTComisionBroker)) ?></td>
											<td class="text-success font-weight-bolder <?php echo ($item->LOTFechaFijacion == "" ? "" : "table-success") ?>"><?php echo $item->LOTPrecioFijacion ?></td>
											<td><?php echo ($item->LOTFechaFijacion == "" ? "" : date("d/m/Y", strtotime($item->LOTFechaFijacion))); ?></td>
										</tr>						
									<?php } } ?>
									</tbody>
								</table>
