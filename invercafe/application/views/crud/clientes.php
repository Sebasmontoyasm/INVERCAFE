			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
						<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-2">
								<!--begin::Page Title-->
								<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Administrar Clientes</h5>
								<!--end::Page Title-->
								<!--begin::Actions-->
									...
									<div id="panel-prog-diaria" class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label font-weight-bolder text-dark">Listado de Clientes</span>
												<span class="text-muted mt-3 font-weight-bold font-size-sm">Se encontraron <?php echo count($clientes); ?> clientes disponibles</span>
											</h3>
											...
											<table id="tbl-clientes" class="table table-header-fixed table-head-custom table-head-bg table-borderless table-vertical-center table-responsive">
												...
												<tbody>
													<?php foreach ($clientes as $indice => $cliente) { ?>
														<tr>
															<td>
																<span class="text-muted font-weight-bold"><?php echo $cliente->CLIENombre ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo $cliente->country_name ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo $cliente->CLIECiudad ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo $cliente->CLIEContacto ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo $cliente->CLIETelefono ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo $cliente->CLIEDireccion ?></span>
															</td>
															<td class="text-center">
																<span class="switch switch-sm">
																	<label>
																		<input type="checkbox" <?php echo ($cliente->CLIEEstado == 1 ? "checked" : ""); ?> onclick="actualizarEstadoCliente(<?php echo $cliente->CLIEId . ", " . ($cliente->CLIEEstado == 1 ? 0 : 1) ?>)"/>
																		<span></span>
																	</label>
																</span>
															</td>
					...
					<div id="mdlGestion" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
						<form id="frmProg" class="form" novalidate="novalidate" data-view="clientes" data-context="clientes">
