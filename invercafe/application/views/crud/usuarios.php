			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
						<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-2">
								<!--begin::Page Title-->
								<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Administrar Usuarios</h5>
								<!--end::Page Title-->
								<!--begin::Actions-->
									...
									<div id="panel-prog-diaria" class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												...
												<span class="text-muted mt-3 font-weight-bold font-size-sm">Se encontraron <?php echo count($usuarios); ?> usuarios disponibles</span>
											</h3>
											...
											<table id="tbl-usuarios" class="table table-head-custom table-head-bg table-borderless table-vertical-center table-responsive">
												...
												<tbody>
													<?php foreach ($usuarios as $indice => $user) { ?>
														<tr>
															<td>
																<span class="text-muted font-weight-bold"><?php echo $user->PERFDescripcion ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo $user->Name ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo $user->LastName ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo $user->UserName ?></span>
															</td>
															<td class="text-center">
																<span class="switch switch-sm">
																	<label>
																		<input type="checkbox" <?php echo ($user->USREstado == 1 ? "checked" : ""); ?> onclick="actualizarEstadoUsuario(<?php echo $user->USRId . ", " . ($user->USREstado == 1 ? 0 : 1) ?>)"/>
																		<span></span>
																	</label>
																</span>
															</td>
															<td class="pr-0 text-right">
																<a href="#!" class="btn btn-icon btn-light btn-hover-primary btn-sm btn-modal-prog" onclick="VerModal('<?php echo $user->USRId . "-" . $user->PERFId ?>')">
					...
					<div id="mdlGestion" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
						<form id="frmProg" class="form" novalidate="novalidate" data-view="usuarios" data-context="usuarios">
