			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
						<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-2">
								<!--begin::Page Title-->
								<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Programación</h5>
								<!--end::Page Title-->
								<!--begin::Actions-->
									...
									<div id="panel-prog-diaria" class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label font-weight-bolder text-dark">Programar agendas futuras</span>
												<span class="text-muted mt-3 font-weight-bold font-size-sm">Este formulario se utiliza extraer agendas entre un rango de fechas y facilitar la corrección de errores para los proximos días. Solo es posible tener una programacion activa, la cuál será ejecutada el día de mañana.</span>
											</h3>
										...
										<div class="card-body">
											<!--begin::Table-->
											<table id="tbl-programacion" class="table table-head-custom table-head-bg table-borderless table-vertical-center table-responsive">
												<thead>
													<tr>
														<th>Fecha Inicial</th>
														<th>Fecha Final</th>
												...
												<tbody>
													<?php foreach ($programacion as $indice => $prog) { ?>
														<tr>
															<td>
																<span class="text-dark-75"><?php echo date('d/m/Y', strtotime($prog->PRGFechaIni)) ?></span>
															</td>
															<td>
																<span class="text-dark-75"><?php echo date('d/m/Y', strtotime($prog->PRGFechaFin)) ?></span>
															</td>
															<td class="text-center">
																<span class="label label-lg label-inline label-light-danger">Programada</span>
															</td>
															<td class="pr-0 text-right">
																<a href="#!" class="btn btn-icon btn-light btn-hover-primary btn-sm btn-modal-prog" onclick="VerModal(<?php echo $prog->PRGId ?>)">
					...
					<div id="mdlGestion" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
						<form id="frmProg" class="form" novalidate="novalidate" data-view="programar" data-context="futuro">
