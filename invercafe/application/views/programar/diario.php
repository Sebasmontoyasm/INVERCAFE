			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
									...
									<div id="panel-prog-diaria" class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label font-weight-bolder text-dark">Agendas diarias</span>
												<span class="text-muted mt-3 font-weight-bold font-size-sm">Se encontraron <?php echo count($programacion); ?> agendas programadas</span>
											</h3>
										...
										<div class="card-body">
											<!--begin::Table-->
											<table id="tbl-programacion" class="table table-head-custom table-head-bg table-borderless table-vertical-center">
												<thead>
													<tr>
														<th>Fecha</th>
														<th>Consultorios</th>
												...
												<tbody>
													<?php foreach ($programacion as $indice => $prog) { ?>
														<tr>
															<td>
																<span class="text-dark-75"><?php echo date('d/m/Y', strtotime($prog->PRGFecha)) ?></span>
															</td>
															<td>
																<span class="text-muted font-weight-bold"><?php echo $prog->PRGConsultorios ?></span>
															</td>
															<td class="text-center">
																<span class="label label-lg label-inline label-light-<?php echo ($prog->PRGEstado == 1 ? "success" : "danger") ?>"><?php echo ($prog->PRGEstado == 1 ? "Ejecutada" : "Programada") ?></span>
															</td>
															<?php if($prog->PRGEstado == 0){ ?>
					...
					<div id="mdlGestion" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
						<form id="frmProg" class="form" novalidate="novalidate" data-view="programar" data-context="diario">
